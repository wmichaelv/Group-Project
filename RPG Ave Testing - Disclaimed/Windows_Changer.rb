...
class Game_Interpreter
  ...
  def window_on(i, name)
    begin
      ...
      p 'make sure that your picture is located on the right folder and has the right name and file extention'
    end
  end
  ...
  def window_depth(i, depth)
    begin
      ...
      p 'no need to have the integer higher than 10 or lower than -10'
    end
  end
  def window_opacity(i, opacity)
    begin
      ...
      p 'make sure that opacity is a number from from 0 - 255'
    end
  end
  ...
  def michael_window_background_sprite(window, i)
    if __method__[0...7] == 48998564589.to_s(36)
      if $game_switches[Windows_Changer::Starting_Switch_Point + i]
        ...
        self.bitmap = Cache.cache_extended(folder, name)
        self.z += $game_message.michael_windows_background_ftw_101[i][2] unless $game_message.michael_windows_background_ftw_101[i][2].nil?
        self.opacity = $game_message.michael_windows_background_ftw_101[i][3] unless !self.visible && $game_message.michael_windows_background_ftw_101[i][3].nil?
        #This is where the sprite_movement come into play
        if $game_message.michael_windows_background_ftw_101[i][4]
          self.x = $game_message.michael_windows_background_ftw_101[i][5] unless $game_message.michael_windows_background_ftw_101[i][5].nil?
          self.y = $game_message.michael_windows_background_ftw_101[i][6] unless $game_message.michael_windows_background_ftw_101[i][6].nil?
          self.src_rect.x = $game_message.michael_windows_background_ftw_101[i][7] unless $game_message.michael_windows_background_ftw_101[i][7].nil?
          self.src_rect.y = $game_message.michael_windows_background_ftw_101[i][8] unless $game_message.michael_windows_background_ftw_101[i][8].nil?
          self.src_rect.width = $game_message.michael_windows_background_ftw_101[i][9] unless $game_message.michael_windows_background_ftw_101[i][9].nil?
          self.src_rect.height = $game_message.michael_windows_background_ftw_101[i][10] unless $game_message.michael_windows_background_ftw_101[i][10].nil?
        end
      else
        #This will return window to default opacity after window_off
        self.visible = false
...
class Game_Interpreter
  ...
  def window_center(i)
    $game_message.michael_windows_background_ftw_101[i][4] = true
    $game_message.michael_windows_background_ftw_101[i][5] = 0
    $game_message.michael_windows_background_ftw_101[i][6] = 0
    $game_message.michael_windows_background_ftw_101[i][7] = 0
    $game_message.michael_windows_background_ftw_101[i][8] = 0
    $game_message.michael_windows_background_ftw_101[i][9] = Graphics.width
    $game_message.michael_windows_background_ftw_101[i][10] = Graphics.height
  end
