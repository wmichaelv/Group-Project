...
module YEA
  module BATTLE
    ...
    #Extra
    #With this you can hide the actor HUD from the character icon
    #Beware, might cause confusion
    #Set 0 to hide, set 1 or other number to show
    HIDE_ACTOR_HUD = 1
...
class Window_BattleStatus < Window_Selectable
  ...
  #--------------------------------------------------------------------------
  def draw_item(index)
    if (YEA::BATTLE::HIDE_ACTOR_HUD != 0)
      return if index.nil?
      clear_item(index)
