...
# Michael Tweak
#==============================================================================
get_screen_width = Win32API.new("User32.dll","GetSystemMetrics",["L"],"L").call(0)
get_screen_height = Win32API.new("User32.dll","GetSystemMetrics",["L"],"L").call(1)
Graphics.resize_screen(get_screen_width, get_screen_height)